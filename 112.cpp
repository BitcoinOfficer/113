...
struct Finding {
    ...
    Finding() : finding_id(0), issue_type(IssueType::PlaintextPasswordRetention),
                ...
                manual_review_required(false), taint_record_id(0), review_tier("informational") {}
...
// ============================================================================
// Out-of-line definition of NoveltyExpansionOrchestrator methods
// (placed here after PatternLibrary and Dynamic*Engine classes are defined)
// ============================================================================
